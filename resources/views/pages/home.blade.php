...
@section('content')
    ...
    <header class="text-center">
        <h1>
          ...
          World As Easy One Click
        </h1>
        <p class="mt-3">
          You will see beuatiful <br />
          moment you never see before
        </p>
        <a href="#" class="btn btn-get-started px-4 mt-4"> Get Strated</a>
    </header>
  
    <!-- Main -->
    <main>
        <div class="container">
          <!-- Justify content center ini adalah apabila buat tabel maka langsung ditengah tidak dari kiri -->
          ...
          <div class="container">
            <div class="section-popular-travel row justify-content-center">
              <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-testimonial text-center">
                  <div class="testimonial-content">
                    <img src=" {{url('frontend/images/avatar-1.png') }}" / alt="User"
                    class="mb-4 rounded-circle">
                    <!-- Rounded circle supaya apabila gambar nya ga bulat langsung bulat -->
                    <h3 class="mb-4">Angga Rizky</h3>
                    <p class="testimonial">
                      "It was glorious and i cloud not stop to say wohooo for
              ...
              <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-testimonial text-center">
                  <div class="testimonial-content">
                    <img src="{{ url ('frontend/images/avatar-2.png') }}" / alt="User"
                    class="mb-4 rounded-circle">
                    <!-- Rounded circle supaya apabila gambar nya ga bulat langsung bulat -->
              ...
              <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-testimonial text-center">
                  <div class="testimonial-content">
                    <img src="{{ url ('frontend/images/avatar-3.png') }}" / alt="User"
                    class="mb-4 rounded-circle">
                    <!-- Rounded circle supaya apabila gambar nya ga bulat langsung bulat -->
